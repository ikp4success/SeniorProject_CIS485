				...
				<div id="page-content-wrapper">
					<div class="col-lg-12">
						<div class="row">
							<div>
								<p>
									<h1>Student User Portal -- UNDER CONSTRUCTION</h1>
...
The Center for eLearning has developed an online student orientation course for students who are interested in learning more about ClickerApp and learning online. If you are taking an online course or program, we recommend enrolling in this short course.

After completing the course, you will be able to:

Navigate the ClickerApp course environment
Edit your personal information and settings
Communicate using messages, email and discussions,
Submit assignments and assessments
Identify behaviors that will help you succeed as an online student<p>
